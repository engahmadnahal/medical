...
class DoctorController extends Controller
{
...

    {
        ...
        $roles = Role::all();
        return view('doctor.craete',['cities'=>$cities,'specialites'=>$specialites,'roles'=>$roles]);
    ...
    public function store(Request $request)
    {
        ...
        //     $doctor->cv = $filename;
        //     $doctor->syncRoles($request->input('role'));
        //     $isSave = $doctor->save();
    ...
    public function edit(Doctor $doctor)
    {
        ...
        return view('doctor.edit',['doctor'=>$doctor,'cities'=>$cities,'specialites'=>$specialites,'roles'=>$roles]);
