...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">{{__('cms.all_city')}}</h2>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{__('cms.all_city')}}</h4>
                        <div class="btn-group">
                            <button class="btn btn-light" onclick="document.location.reload()"><i class="bx bx-refresh"></i></button> <a
                                class="btn btn-light " href="{{route('cities.trash')}}"><i class="bx bx-archive"></i></a>
                        </div>
                        <div class="pr-1 mb-3 mb-xl-0">
                            <a href="{{route('cities.create')}}" class="btn btn-primary btn-icon ml-2"><i
                        ...
                        <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="wd-lg-8p"><span>{{ __('cms.name_city_ar') }}</span></th>
                                    <th class="wd-lg-20p"><span>{{ __('cms.name_city_en') }}</span></th>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('cities.edit', $citiy->id) }}" class="btn btn-sm btn-info">
                                                <i class="las la-pen"></i>
                                            </a>
                                            <form action="{{ route('cities.destroy', $citiy->id) }}" method="post" class="btn btn-sm btn-danger">
                                                @csrf
                                                @method('DELETE')
