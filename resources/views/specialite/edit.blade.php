...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">{{ __('cms.add_specialite') }}</h2>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="form-group">
                            ...
                            <input type="checkbox" id="active_pateint" style="display: none" name="active" @if($specialite->active == 1) checked @endif>
                            <div class="active-pateint main-toggle main-toggle-success @if($specialite->active == 1) on @endif">
                                <span></span>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="card-body">
                            <div class="main-content-label mg-b-5">
                                {{ __('cms.info_specialite') }}
                            </div>
                            <div class="row row-sm">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('cms.name_specialite_ar') }} : </label>
                                        <input class="form-control" name="name_ar" type="text" id="name_ar"
                                            placeholder="{{ __('cms.name_specialite_ar') }} " value="{{ old('name_ar')??$specialite->name_ar }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row row-sm">
                                 <div class="col-12">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('cms.name_specialite_en') }} : </label>
                                        <input class="form-control" name="name_en" type="text" id="name_en"
                                            placeholder="{{ __('cms.name_specialite_en') }}" value="{{ old('name_en')??$specialite->name_en }}">
                                    </div>
                                </div>
                            </div>
