...
@endsection
@section('user_name_side', $data->first_name . ' ' . $data->last_name)
@section('user_type__side', $data->degree ?? '')
@section('user_name_head', $data->first_name . ' ' . $data->last_name)
@section('user_type__head', $data->degree ?? '')
@section('user_avater_head', asset('upload/files/') . $data->avater)
@section('user_avater_side', asset('upload/files/') . $data->avater)
