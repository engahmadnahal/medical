...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">{{ __('cms.add_doctor') }}</h2>
            </div>
        </div>
                    ...
                    <div class="card-body pb-0">
                            ...
                            <select name="specialite" class="form-control select2 select2-hidden-accessible"
                                ...
                                @foreach ($specialites as $specialite)
                                    <option value="{{ $specialite->id }}"
                                        @if ($specialite->id == old('city')) selected @endif>{{ $specialite->name_ar }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="degree" id="degree" class="form-control nice-select custom-select"
                                ...
                                <option value="doctors" @if (old('degree') == 'doctors') selected @endif>دكتوراه</option>
                                <option value="master" @if (old('degree') == 'master') selected @endif>ماجيستير</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="gender" id="gender" class="form-control nice-select custom-select"
                                ...
                                <option value="M" @if (old('gender') == 'M') selected @endif>ذكر</option>
                                <option value="F" @if (old('gender') == 'F') selected @endif>اثنى</option>
                            </select>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-body">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="work_id" type="text" id="work_id"
                                            placeholder="{{ __('cms.worked_id') }} " value="{{ old('work_id') }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="date_birth" type="text" id="date_birth"
                                            placeholder="{{ __('cms.date_birth') }} " value="{{ old('date_birth') }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="password" type="password" id="password"
                                            placeholder="{{ __('cms.password') }}" value="{{ old('password') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="start_time" type="text" id="start_time"
                                            placeholder="{{ __('cms.start_work') }} " value="{{ old('start_time') }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="end_time" type="text" id="end_time"
                                            placeholder="{{ __('cms.end_work') }}" value="{{ old('end_time') }}">
                                    </div>
                                </div>
                            ...
                            <div class="row row-sm">
                                <div class='col-12'>
                                    <input type="file" class="cv" data-height="200" id="cv" name="cv">
                                </div>
                            </div>
                        </div>
                    </div>
